...
export function Dashboard({ onLogout }: DashboardProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-green-50/30 to-emerald-50/50">
      {/* Header */}
      <header className="bg-white border-b border-green-100/50 shadow-sm sticky top-0 z-40 backdrop-blur-sm bg-white/95">
            ...
            <div className="flex items-center gap-6">
              ...
              <nav className="hidden lg:flex items-center gap-2">
                ...
                >
                  <Button
                    size="sm"
                    variant={activeMenu === "Accounts" || activeMenu === "Employees" ? "default" : "ghost"}
                    style={{
                      backgroundColor: activeMenu === "Accounts" || activeMenu === "Employees" 
                        ? undefined 
                        : hoveredMenu === "Settings" 
                          ? "#dcfce7" 
                          : undefined
                    }}
                    className={activeMenu === "Accounts" || activeMenu === "Employees"
                      ? "bg-gradient-to-r from-green-600 to-emerald-600 text-white"
                      : "text-green-700 transition-all"}
                  >
